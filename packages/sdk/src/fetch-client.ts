...
export type SharedLibraryResponseDto = {
    ...
    /** Library ID */
    id: string;
    /** Whether this shared library appears in your main timeline, explore, map & search */
    inTimeline: boolean;
    /** Library name */
    name: string;
    owner: UserResponseDto;
...
export type LibraryUserSelfUpdateDto = {
    /** Show this shared library's assets in your main timeline, explore, map & search */
    inTimeline: boolean;
};
...
export type LibraryAssetBulkUpdateDto = {
    /** Original date and time */
    dateTimeOriginal?: string;
    /** Relative time offset in minutes */
    dateTimeRelative?: number;
...
export type LibraryFaceAssignDto = {
    /** Faces within this library to (re)assign */
    faceIds: string[];
...
export type LibraryPersonResponseDto = {
    ...
    /** Person name */
    name: string;
    /** This person's global thumbnail is never returned here, since its source face may be outside this library. Null when the person has no visible face within this library. */
...
export type LibraryPersonCreateDto = {
    /** Faces within this library to assign to the new person */
    faceIds: string[];
    /** Person name */
    name: string;
};
 ...
 * Share a library
 */
export function addLibraryUsers({ id, libraryUsersDto }: {
    id: string;
    libraryUsersDto: LibraryUsersDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: LibraryUserResponseDto[];
    }>(`/libraries/${encodeURIComponent(id)}/users`, oazapfts.json({
        ...opts,
        method: "PUT",
...
/**
 * Update my library share preferences
 */
export function updateMyLibraryShare({ id, libraryUserSelfUpdateDto }: {
    id: string;
    libraryUserSelfUpdateDto: LibraryUserSelfUpdateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: SharedLibraryResponseDto;
    }>(`/libraries/${encodeURIComponent(id)}/users/me`, oazapfts.json({
        ...opts,
        method: "PUT",
        body: libraryUserSelfUpdateDto
    })));
}
/**
 * Remove a library user
 */
export function removeLibraryUser({ id, userId }: {
    id: string;
    userId: string;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText(`/libraries/${encodeURIComponent(id)}/users/${encodeURIComponent(userId)}`, {
        ...opts,
        method: "DELETE"
    }));
}
 ...
 */
export function updateLibraryUser({ id, userId, libraryUserUpdateDto }: {
    id: string;
    userId: string;
    libraryUserUpdateDto: LibraryUserUpdateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: LibraryUserResponseDto;
    }>(`/libraries/${encodeURIComponent(id)}/users/${encodeURIComponent(userId)}`, oazapfts.json({
        ...opts,
        method: "PUT",
 ...
 */
export function updateLibraryAssets({ libraryId, libraryAssetBulkUpdateDto }: {
    libraryId: string;
    libraryAssetBulkUpdateDto: LibraryAssetBulkUpdateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: AssetResponseDto[];
    }>(`/libraries/${encodeURIComponent(libraryId)}/assets`, oazapfts.json({
        ...opts,
        method: "PATCH",
 ...
 */
export function updateLibraryAsset({ assetId, libraryId, libraryAssetUpdateDto }: {
    assetId: string;
    libraryId: string;
    libraryAssetUpdateDto: LibraryAssetUpdateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: AssetResponseDto;
    }>(`/libraries/${encodeURIComponent(libraryId)}/assets/${encodeURIComponent(assetId)}`, oazapfts.json({
        ...opts,
        method: "PATCH",
 ...
 */
export function getLibraryAssetFaces({ assetId, libraryId }: {
    assetId: string;
    libraryId: string;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
 ...
 */
export function createLibraryFace({ libraryId, libraryManualFaceDto }: {
    libraryId: string;
    libraryManualFaceDto: LibraryManualFaceDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 201;
        data: LibraryFaceResponseDto;
    }>(`/libraries/${encodeURIComponent(libraryId)}/faces`, oazapfts.json({
        ...opts,
        method: "POST",
 ...
 */
export function assignLibraryFaces({ libraryId, libraryFaceAssignDto }: {
    libraryId: string;
    libraryFaceAssignDto: LibraryFaceAssignDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: LibraryFaceResponseDto[];
 ...
 */
export function getLibraryPeople({ libraryId, page, size }: {
    libraryId: string;
    page?: number;
    size?: number;
}, opts?: Oazapfts.RequestOpts) {
    ...
    }>(`/libraries/${encodeURIComponent(libraryId)}/people${QS.query(QS.explode({
        page,
        size
    }))}`, {
        ...opts
 ...
 */
export function createLibraryPerson({ libraryId, libraryPersonCreateDto }: {
    libraryId: string;
    libraryPersonCreateDto: LibraryPersonCreateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 201;
        data: LibraryPersonResponseDto;
    }>(`/libraries/${encodeURIComponent(libraryId)}/people`, oazapfts.json({
        ...opts,
        method: "POST",
 ...
 */
export function updateLibraryPerson({ libraryId, personId, libraryPersonUpdateDto }: {
    libraryId: string;
    personId: string;
    libraryPersonUpdateDto: LibraryPersonUpdateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: LibraryPersonResponseDto;
    }>(`/libraries/${encodeURIComponent(libraryId)}/people/${encodeURIComponent(personId)}`, oazapfts.json({
        ...opts,
        method: "PUT",
 ...
 */
export function getMapMarkers({ fileCreatedAfter, fileCreatedBefore, isArchived, isFavorite, withPartners, withSharedAlbums, withSharedLibraries }: {
 ...
 * Get time bucket
 */
export function getTimeBucket({ albumId, bbox, isFavorite, isTrashed, key, libraryId, order, orderBy, personId, slug, tagId, timeBucket, userId, visibility, withCoordinates, withPartners, withSharedLibraries, withStacked }: {
    albumId?: string;
    bbox?: string;
    isFavorite?: boolean;
    isTrashed?: boolean;
 ...
 * Get time buckets
 */
export function getTimeBuckets({ albumId, bbox, isFavorite, isTrashed, key, libraryId, order, orderBy, personId, slug, tagId, userId, visibility, withCoordinates, withPartners, withSharedLibraries, withStacked }: {
    albumId?: string;
    bbox?: string;
    isFavorite?: boolean;
    isTrashed?: boolean;
...
export enum Permission {
    ...
    LibraryFaceCreate = "libraryFace.create",
    LibraryFaceUpdate = "libraryFace.update",
