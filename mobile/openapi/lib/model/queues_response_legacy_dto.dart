...
class QueuesResponseLegacyDto {
  ...
  QueueResponseLegacyDto videoFaceDetection;
  ...
  static QueuesResponseLegacyDto? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return QueuesResponseLegacyDto(
        ...
        videoFaceDetection: QueueResponseLegacyDto.fromJson(json[r'videoFaceDetection'])!,
